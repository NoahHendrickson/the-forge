...
import { alignSelfRowOn, fillIsEmpty, minMaxRowVisible, normalizeAlign, strokeIsEmpty } from '../../src/client/panel-readers'

// marginSectionVisible (and its tests) died with the Margin section — 2026-07-22 Figma pivot.
