...
export const TOKENS = {
  ...
  'text-sm': '11px',
  'text-md': '12px',
  'chat-textarea-max': `${TEXTAREA_MAX_PX}px`,
...
// feed's own persistent element chip + chat input (chat-styles.ts), so there is no more
// shadow-root sibling popup to style here.
`
` +
CHAT_CSS +
